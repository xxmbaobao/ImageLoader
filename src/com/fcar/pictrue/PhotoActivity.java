...
public class PhotoActivity extends Activity {
	...
	private void initListViews(Bitmap bm) {
		...
		ImageView img = new ImageView(this);// 鏋勯�textView瀵硅�?
	...
	private OnPageChangeListener pageChangeListener = new OnPageChangeListener() {
		...
		public void onPageScrollStateChanged(int arg0) {// 婊戝姩鐘舵��?���?
	...
	class MyPageAdapter extends PagerAdapter {
		...
		public void setListViews(ArrayList<View> listViews) {// 鑷繁鍐欑殑涓�釜鏂规硶鐢ㄦ潵娣诲姞鏁版�?
			this.listViews = listViews;
			size = listViews == null ? 0 : listViews.size();
		}
		...
		public void destroyItem(View arg0, int arg1, Object arg2) {// 閿�瘉view瀵硅�?
